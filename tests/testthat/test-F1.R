...
test_that("Error if none is not part of opts", {
  expect_error(f1(data = HOT, opts = c(Option_1:Option_3), choice = choice,
                  none = None))
})
...
test_that("Warning if group contains NA ", {
  ...
  expect_warning(f1(data = HOT2, opts = c(Option_1:None), choice = choice,
...
test_that("Error if alternatives contains NA ", {
  ...
  expect_error(f1(data = HOT2, opts = c(Option_1:None), choice = choice,
                  none = None, group = Group))
})
...
test_that("Structure of Output data.frame ", {
  expect_true(base::is.data.frame(f1(data = HOT, opts = c(Option_1:None),
                                     choice = choice, none = None)))
})

test_that("Structure of Output tibble ", {
  expect_true(tibble::is_tibble(f1(data = HOT, opts = c(Option_1:None),
                                   choice = choice, none = None)))
})

test_that("Length of output equals number of groups - no group ", {
  expect_equal(base::nrow(f1(data = HOT, opts = c(Option_1:None),
...
test_that("Numeric output - no group ", {
  expect_true(base::is.numeric(f1(data = HOT, opts = c(Option_1:None),
                                  choice = choice, none = None)[[1]]))
})
...
test_that("group output equals group input ", {
  expect_equal(utils::str(f1(data = HOT, opts = c(Option_1:None),
                             choice = choice, none = None, group = Group)[[1]]),
               utils::str(HOT$Group))
})
...
test_that("group output equals group input - character input ", {
  ...
  expect_equal(utils::str(f1(data = HOT, opts = c(Option_1:None),
                             choice = choice, none = None,
                             group = Group2)[[1]]), utils::str(HOT$Group2))
})
...
test_that("group output equals group input - labelled input ", {
  ...
  expect_true(labelled::is.labelled(f1(data = HOT, opts = c(Option_1:None),
                                       choice = choice, none = None,
                                       group = Group2)[[1]]))
})
...
test_that("f1() also working with data.frame not created with createHOT()", {
  ...
  expect_true(base::is.numeric(f1(data = newHOT, opts = c(Option_1:Option_5),
                                  choice = Choice, none = Option_3)[[1]]))
  expect_true(tibble::is_tibble(f1(data = newHOT, opts = c(Option_1:Option_5),
                                   choice = Choice, none = Option_5)))
  expect_false(base::anyNA(f1(data = newHOT, opts = c(Option_1:Option_5),
                              choice = Choice, none = Option_5)))
})

test_that("check whether examples are correct ", {
  expect_equal(base::round(base::as.numeric(f1(data = HOT,
