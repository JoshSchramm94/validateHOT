...
test_that("Error if alternatives contains NA ", {
  ...
  expect_error(freqassort(
    data = HOT2, opts = c(Option_1, Option_2, Option_6),
    none = None, group = Group
  ))
})
...
test_that("Structure of Output data.frame ", {
  expect_true(is.data.frame(freqassort(
    data = HOT,
    opts = c(
      Option_1, Option_2,
      Option_6
...
test_that("Structure of Output tibble ", {
  expect_true(tibble::is_tibble(freqassort(
    data = HOT,
    opts = c(
      Option_1, Option_2,
      Option_6
...
test_that("Numeric output - no group ", {
  expect_true(is.numeric(freqassort(
    data = HOT,
    opts = c(
      Option_1, Option_2,
      Option_6
...
test_that("group output equals group input - labelled input ", {
  ...
  expect_true(labelled::is.labelled(freqassort(
    data = HOT,
    opts = c(
      Option_1, Option_2,
      Option_6
...
test_that("check whether examples are correct ", {
  expect_equal(round(as.numeric(freqassort(
    data = HOT,
    opts = c(
      Option_1,
      Option_2,
