...
#'
#' @description `mae()` calculates the mean absolute error of a
#' validation task, which is the aggregated deviation between predicted and
...
#' stated (i.e., actual) choice shares. It is an aggregated value across all
