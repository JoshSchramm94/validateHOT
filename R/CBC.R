...
#'   \item{price_1}{(numeric) Part-worth utility for price level 1}
#'   \item{price_2}{(numeric) Part-worth utility for price level 2}
#'   \item{price_3}{(numeric) Part-worth utility for price level 3}
#'   \item{price_4}{(numeric) Part-worth utility for price level 4}
#'   \item{price_5}{(numeric) Part-worth utility for price level 5}
#'   \item{price_6}{(numeric) Part-worth utility for price level 6}
